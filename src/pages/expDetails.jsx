        ...
        <section className='my-12'>
            <Grid container spacing={4}>
                <Grid item md={12}>
                    ...
                    <BounceInDownButton>
                        <p className='text-purple-600 font-bold mb-4 text-2xl md:text-4xl'>Experience</p>
                    </BounceInDownButton>
                    <ol className="relative border-s border-purple-700">
                        {experience.map((e, i) => (
                            <TimeLine
                                key={i}
                                index={i}
                ...
                {/* <Grid item md={6} >
                    <p className='dark:text-white opacity-60 text-sm md:text-md'>Know about my</p>
                    <BounceInDownButton>
                        <p className='text-purple-600 font-bold mb-4 text-2xl md:text-4xl'>Education</p>
                    </BounceInDownButton>
                    <div className='my-12'>
                        <ol className="relative border-s border-purple-700">
                            {education.map((e, i) => (
