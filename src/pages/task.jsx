...
function Task() {
    ...
    return (
        <section>
            <button className='bg-purple-600 rounded-full px-6 py-2' onClick={toggle}>button</button>
                    ...
                    <article className="md:gap-8 md:grid md:grid-cols-3">
                        ...
                        <div className="col-span-2 mt-6 md:mt-0 text-white">
                            ...
                            <aside className="flex items-center mt-3">
                                <a href="#" className="inline-flex items-center text-sm font-medium text-purple-500 hover:underline dark:text-purple-400">
                                    Helpful
                                </a>
                                <a href="#" className="inline-flex items-center text-sm font-medium text-purple-500 hover:underline dark:text-purple-400 group ms-5">
                                    Not helpful
                                </a>
                            </aside>
                        </div>
